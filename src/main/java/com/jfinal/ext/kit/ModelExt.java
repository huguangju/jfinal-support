...
public class ModelExt<M extends ModelExt<M>> extends Model<M> {
    ...
    public boolean save() {
        ...
        if (pseudoDelete()) {
            if (!Table.hasColumnLabel(deleteColumnLabel)) {
    ...
    public boolean deleteById(Object id) {
        ...
        if (pseudoDelete()) {
            ...
            String sql = "update "+Table.getName()+" set "+deleteColumnLabel+" = 1 where "+pKey+" = ?";
	...
	public int deleteByColumns(List<String> columns, List<Object> values) {
        ...
        if (pseudoDelete()) {
            ...
            String pKey = Table.getPrimaryKey();
            sql+= "update "+Table.getName()+" set "+deleteColumnLabel+" = 1";
        }else{
